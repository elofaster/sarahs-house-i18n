...
An unofficial multilingual mod for Sarah's House (Windows, v0.11.2).
...
1. Unzip the release archive into the game folder, next to `SarahsHouse.exe`.
2. Launch the game — the first start may take 1–3 minutes to set up.
3. Pick your language from the in-game panel: press `F10` (or the language icon in the top-right corner).

## Repository

- `docs/` — the website (GitHub Pages)
- `mod/` — the mod itself — plugin, language packs and fonts

---

An unofficial fan mod. Not affiliated with AceStudio.
