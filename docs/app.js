(() => {
  ...
  const I18N = {
    ru: {
      ...
      "meta.og": "Неофициальный мод перевода для Sarah’s House 0.11.6",
      "nav.languages": "Языки",
      ...
      "install.need": "Нужна Sarah's House v0.11.6. Игра в архив не входит.",
      ...
      "finale.title": "Скачать мод v2.9.1",
    ...
    en: {
      ...
      "meta.og": "Unofficial translation mod for Sarah’s House 0.11.6",
      ...
      "install.need": "Requires Sarah's House v0.11.6. The game is not included in the archive.",
      ...
      "finale.title": "Download mod v2.9.1",
      "finale.sub": "ZIP · soon · free for everyone",
    ...
    de: {
      ...
      "meta.og": "Inoffizieller Übersetzungsmod für Sarah’s House 0.11.6",
      ...
      "install.need": "Benötigt Sarah's House v0.11.6. Das Spiel ist nicht im Archiv enthalten.",
      ...
      "finale.title": "Mod v2.9.1 herunterladen",
      "finale.sub": "ZIP · soon · free for everyone",
    ...
    uk: {
      ...
      "meta.og": "Неофіційний мод перекладу для Sarah’s House 0.11.6",
      "nav.languages": "Мови",
      ...
      "install.need": "Потрібна Sarah's House v0.11.6. Гра не входить до архіву.",
      ...
      "finale.title": "Завантажити мод v2.9.1",
      "finale.sub": "ZIP · soon · free for everyone",
    ...
    es: {
      ...
      "meta.og": "Mod de traducción no oficial para Sarah’s House 0.11.6",
      ...
      "install.need": "Necesitas Sarah's House v0.11.6. El juego no está en el archivo.",
      ...
      "finale.title": "Descargar mod v2.9.1",
      "finale.sub": "ZIP · soon · free for everyone",
    ...
    fr: {
      ...
      "meta.og": "Mod de traduction non officiel pour Sarah’s House 0.11.6",
      ...
      "install.need": "Sarah's House v0.11.6 est requis. Le jeu n'est pas inclus dans l'archive.",
      ...
      "finale.title": "Télécharger le mod v2.9.1",
      "finale.sub": "ZIP · soon · free for everyone",
    ...
    zh: {
      ...
      "meta.og": "Sarah’s House 0.11.6 非官方翻译模组",
      "nav.languages": "语言",
      "nav.install": "安装",
      "nav.gallery": "画廊",
      "nav.contribute": "贡献",
      ...
      "install.eyebrow": "安装",
      "install.title": "如何安装",
      "install.need": "需要 Sarah's House v0.11.6。压缩包内不含游戏本体。",
    ...
    tr: {
      ...
      "meta.og": "Sarah’s House 0.11.6 için gayri resmi çeviri modu",
      ...
      "install.need": "Sarah's House v0.11.6 gerekli. Oyun arşive dahil değildir.",
      ...
      "finale.title": "Modu indir v2.9.1",
    ...
    ja: {
      ...
      "meta.og": "Sarah’s House 0.11.6 非公式翻訳MOD",
      "nav.languages": "言語",
      "nav.install": "インストール",
      "nav.gallery": "ギャラリー",
      "nav.contribute": "貢献",
      ...
      "install.need": "Sarah's House v0.11.6 が必要です。ゲーム本体は含まれません。",
      ...
      "finale.title": "MOD v2.9.1 をダウンロード",
  ...
  I18N.ko = {
    ...
    "meta.og": "Sarah’s House 0.11.6 비공식 번역 모드",
    "nav.languages": "언어",
    "nav.install": "설치",
    "nav.gallery": "갤러리",
    "nav.contribute": "수정",
    ...
    "install.eyebrow": "설치",
    "install.title": "설치 방법",
    "install.need": "Sarah's House v0.11.6 가 필요합니다. 게임 본체는 포함되지 않습니다.",
  ...
  I18N.vi = {"meta.title":"Sarah’s House — bản mod dịch","meta.description":"Bản mod đa ngôn ngữ không chính thức cho Sarah’s House. 11 ngôn ngữ hoàn chỉnh (100%): RU, UK, DE, ES, FR, ZH, TR, PT, JA, KO, PL.","meta.og":"Bản mod dịch không chính thức cho Sarah’s House 0.11.6","nav.languages":"Ngôn ngữ","nav.install":"Cài đặt","nav.gallery":"Thư viện ảnh","nav.contribute":"Đóng góp","nav.download":"Tải xuống","hero.title":"giờ đã có tiếng Việt","hero.lede":"Toàn bộ trò chơi bằng ngôn ngữ của bạn. Tải tệp nén về, giải nén vào thư mục game và chơi thôi.","hero.download":"Tải mod","hero.downloadSub":"ZIP · 68 MB","packs.eyebrow":"Ngôn ngữ","packs.title":"Trạng thái các gói","packs.ingame":"Trong game:","packs.cycle":"chuyển vòng:","packs.latestTitle":"Bản dịch hoàn thành mới nhất","packs.latestSub":"gói ngôn ngữ hoàn chỉnh mới nhất","packs.othersTitle":"Tất cả ngôn ngữ khác","packs.othersSub":"các gói gọn nhẹ trong một danh sách chung","packs.author":"Tác giả","packs.offer":"Muốn thêm bản dịch của riêng bạn?","packs.offer.step1":"Fork kho elofaster/sarahs-house-i18n.","packs.offer.step2":"Tạo tệp ngôn ngữ trong mod/i18n/, ví dụ it.json, pl.json, ja.json hoặc ko.json.","packs.offer.step3":"Ở đầu tệp, ghi nickname của bạn vào khóa \"__meta.author\".","packs.offer.step4":"Thêm các dòng dịch theo định dạng \"english text\": \"bản dịch của bạn\".","packs.offer.step5":"Mở Pull Request vào main — sau khi kiểm duyệt, gói sẽ xuất hiện trên trang.","packs.offer.cta":"Tạo tệp dịch trên GitHub","packs.lines":"Số dòng","packs.completeness":"Mức hoàn thành","status.ready":"sẵn sàng","status.wip":"đang làm","lang.ru":"Tiếng Nga","lang.en":"Tiếng Anh","lang.de":"Tiếng Đức","lang.fr":"Tiếng Pháp","lang.uk":"Tiếng Ukraina","lang.es":"Tiếng Tây Ban Nha","install.eyebrow":"Cài đặt","install.title":"Cách cài đặt","install.need":"Yêu cầu Sarah's House v0.11.6. Trò chơi không đi kèm trong tệp nén.","install.downloadZip":"Tải ZIP","install.step1Title":"Tải về","install.step2Title":"Giải nén","install.step2Text":"bằng trình giải nén vào thư mục game, cạnh SarahsHouse.exe","install.step3Title":"Khởi động","install.step3Text":"lần chạy đầu mất 1–3 phút","install.remove":"Gỡ bỏ:","gallery.eyebrow":"Thư viện ảnh","gallery.title":"Từ trong game","contribute.eyebrow":"Đóng góp","contribute.title":"Muốn đề xuất chỉnh sửa?","contribute.cta":"Đề xuất chỉnh sửa","finale.title":"Tải mod v2.9.1","finale.sub":"ZIP · 68 MB · miễn phí cho mọi người","footer.note":"Mod không chính thức. Không liên quan đến AceStudio.","footer.game":"Trò chơi","a11y.skip":"Chuyển đến nội dung","hero.free":"miễn phí cho mọi người","footer.legal":"Mọi bản dịch thuộc về tác giả của chúng khi tác giả được ghi rõ. Các bản dịch do mạng nơ-ron thực hiện thuộc về dự án. Tất cả bản dịch đều là mã nguồn mở, trừ các gói của tác giả — những gói đó được đăng với sự đồng ý của tác giả.","footer.contact":"Nếu bản dịch của bạn được nhắc đến ở đây — hãy viết cho chúng tôi:","footer.project":"Dự án","footer.translators":"Dành cho dịch giả","footer.top":"Lên đầu trang","contribute.addLang":"Thêm ngôn ngữ của bạn","contribute.sub":"Thấy lỗi chính tả hay câu văn chưa mượt? Sửa qua pull request chỉ mất vài phút — ngay trên trình duyệt.","finale.started":"Đã bắt đầu tải xuống","packs.ingamePath":"Preferences → Language","dialog.hint":"Nhấp — ngôn ngữ tiếp theo","dialog.line":"Giờ thì bạn hiểu từng lời thoại.","gallery.open":"Mở ảnh chụp","gallery.cap1":"Buổi sáng trong phòng tắm","gallery.cap2":"Chiều Chủ Nhật","gallery.cap3":"Trò chuyện trong phòng","gallery.cap4":"Sảnh vào nhà","lightbox.close":"Đóng","lightbox.prev":"Trước","lightbox.next":"Tiếp","lang.zh":"Tiếng Trung","lang.tr":"Tiếng Thổ Nhĩ Kỳ","lang.pt":"Tiếng Bồ Đào Nha","lang.ja":"Tiếng Nhật","packs.totalLines":"Tổng số dòng đã dịch:","footer.brandSub":"Mod dịch","packs.offer.exVal":"Bạn khỏe không?","lang.ko":"Tiếng Hàn","install.step4Title":"Menu ngôn ngữ","install.step4Text":"mở bảng chuyển ở góc trên bên phải","install.step5Title":"Chọn ngôn ngữ","install.step5Text":"chọn tiếng Việt và chơi thôi","lang.pl":"Tiếng Ba Lan","lang.vi":"Tiếng Việt"};
  (function(){var N={"ru":"Вьетнамский","en":"Vietnamese","de":"Vietnamesisch","uk":"В'єтнамська","es":"Vietnamita","fr":"Vietnamien","zh":"越南语","tr":"Vietnamca","ja":"ベトナム語","ko":"베트남어","pl":"Wietnamski","vi":"Tiếng Việt"};for(var _l in I18N){if(I18N[_l]&&!I18N[_l]["lang.vi"])I18N[_l]["lang.vi"]=N[_l]||"Tiếng Việt";}})();
